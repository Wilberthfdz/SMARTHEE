	...
	<div class="kr_blog_post_area undblg">
		...
		<div class="row">
			{foreach from=$wbblogpost item=xpblgpst}
				...
				<article id="blog_post" class="archb blog_post_{$xpblgpst.post_format} col-lg-4 col-md-6 col-xs-12 col-sm-12">
						<div class="blogbg">
...
{block name="left_column"}
	...
	{if ($layout_column == 'layout-left-column')}
		<div id="left-column" class="sidebar col-xs-12 col-sm-4 col-md-3 col-lg-2">
			<div class="lmain">
