...
<div class="product-tab-item next-prevb">
<div class="pro-tab tabs text-capitalize text-xs-right">
    <h2 class="pull-left">{l s='top product' d='Shop.Theme.Catalog'}</h2>
...
<section id="tab-fea-0" class="tab-pane active clearfix fadeInUp animated">
